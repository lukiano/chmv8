...
public final class ConcurrentHashMapV8<K, V>
    implements ConcurrentMapV8<K, V>, Serializable {
  ...
  */
  ...
  private final Object internalComputeIfAbsent(K k, Function<? super K, ?> mf) {
    int h = spread(k.hashCode());
    Object val = null;
    for (Node[] tab = table;;) {
  ...
  private final Object internalCompute(K k, Function2<? super K, V, V> mf) {
    int h = spread(k.hashCode());
    Object val = null;
    boolean added = false;
    boolean checkSize = false;
  ...
  */
   ...
   */
  @SuppressWarnings("unchecked")
  @Override public V compute(K key, Function2<? super K, V, V> remappingFunction) {
